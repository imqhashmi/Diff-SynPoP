...
# # cross_table_tensor5 = torch.tensor(list(cross_table5a.values()), dtype=torch.float32).to(device)
...
df_hh = pd.DataFrame(records_hh, columns=['composition', 'ref_ethnicity', 'ref_religion'])
print(df_hh)
...
# plot(cross_table_tensor5, aggregated_population5, cross_table5a, 'Age-Sex-HouseholdComposition')
